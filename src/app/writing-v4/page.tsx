...
export default function WritingV4Page() {
  return (
    <div className="page-enter" style={{ padding: '60px 0' }}>
      <div className="container">
        ...
        <section style={{ marginBottom: '56px' }}>
          <h2 style={sectionHeaderStyle}>Books</h2>
        ...
        {/* Essays */}
        <section style={{ marginBottom: '56px' }}>
          <h2 style={sectionHeaderStyle}>Essays</h2>
        ...
        {/* Opinion */}
        <section style={{ marginBottom: '56px' }}>
          <h2 style={sectionHeaderStyle}>Opinion</h2>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            {opinion.map((item, i) => (
              item.url && item.url !== '#'
                ? <a key={i} href={item.url} target="_blank" rel="noopener noreferrer" style={linkItemStyle}>{item.text}</a>
        ...
        {/* Journal Articles */}
        <section style={{ marginBottom: '56px' }}>
          <h2 style={sectionHeaderStyle}>Journal Articles</h2>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
        ...
        {/* Book Chapters */}
        <section style={{ marginBottom: '56px' }}>
          <h2 style={sectionHeaderStyle}>Book Chapters</h2>
          <div style={{ display: 'flex', flexDirection: 'column' }}>
