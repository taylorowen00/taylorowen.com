...
function AccordionSection({ title, count, isOpen, onToggle, children }: AccordionSectionProps) {
  return (
    <div
      style={{
        borderLeft: `4px solid ${isOpen ? 'var(--color-accent)' : 'var(--color-border-light)'}`,
        marginBottom: '24px',
    ...
    >
      ...
      {isOpen && (
        <div style={{ paddingLeft: '20px', paddingBottom: '16px', paddingRight: '8px' }}>
          {children}
        </div>
      )}
    </div>
...
export default function WritingV6Page() {
  ...
  return (
    <div className="page-enter" style={{ padding: '60px 0' }}>
      <div className="container">
        ...
        {/* Accordion sections with left-border accent */}
        <div>
          <AccordionSection
            title="Books"
            count={books.length}
          ...
          <AccordionSection
            ...
            isOpen={openSections.opinion}
            onToggle={() => toggle('opinion')}
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
              {opinion.map((item, i) => (
                item.url && item.url !== '#'
          ...
          <AccordionSection
            ...
            count={journalArticlesPeerReviewed.length + journalArticlesNonPeerReviewed.length}
            isOpen={openSections.journalArticles}
            onToggle={() => toggle('journalArticles')}
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
          ...
          <AccordionSection
            ...
            isOpen={openSections.bookChapters}
            onToggle={() => toggle('bookChapters')}
          >
            <div style={{ display: 'flex', flexDirection: 'column' }}>
